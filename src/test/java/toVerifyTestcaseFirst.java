...
public class toVerifyTestcaseFirst {
	...
	public static void main(String[] args) throws AWTException, InterruptedException 
	{
		...
		*/
		...
		if(popup.isDisplayed())
		{
			...
			//side panel
			/* WebElement collaboration = driver.findElement(By.xpath("//div/button[@class=btn rounded-circle btn-dark]" ));
			
			Actions action =new Actions(driver);
			action.moveToElement(collaboration).perform();	
